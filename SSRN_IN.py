...
mat_data = sio.loadmat('/home/beer/Projects/SSRN/datasets/IN/Indian_pines_corrected.mat')

data_IN = mat_data['indian_pines_corrected']
mat_gt = sio.loadmat('/home/beer/Projects/SSRN/datasets/IN/Indian_pines_gt.mat')
...
for index_iter in range(ITER):
    ...
    best_weights_RES_path_ss4 = '/home/beer/Projects/SSRN/models/Indian_best_RES_3D_SS4_10_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats(KAPPA_RES_SS4, OA_RES_SS4, AA_RES_SS4, ELEMENT_ACC_RES_SS4,
                             ...
                             '/home/beer/Projects/SSRN/records/IN_train_SS_10.txt',
                             '/home/beer/Projects/SSRN/records/IN_train_SS_element_10.txt')
